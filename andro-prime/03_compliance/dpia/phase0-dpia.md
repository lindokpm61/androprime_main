...
| **Abnormal result not escalated** | Low | Very high | Vitall's clinical governance team reviews every result pre-CQC. Escalation protocol is Vitall's responsibility under their clinical governance framework. Post-CQC, escalation transfers to Dr Ewa Lindo. | Very low |
