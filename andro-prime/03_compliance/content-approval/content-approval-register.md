...
**As of 2026-05-18: 5 APPROVED (copy), 2 PENDING (solicitor outstanding).**
Ewa + Keith signed off 2026-05-18 (transcribed on Keith's explicit instruction;
Ewa's sign-off recorded on Keith's representation — Ewa countersignature
recommended for the clinical record). CA-001/002 await the solicitor money
clause. APPROVED here means copy-approved — see each record for ship/build
conditions (PDF comment-block strip, 48h-SLA re-sweep, CIO build gating).
...
| CA-008 | FM CTA language (seq-03b + T-04 + /founding-member page + ResultConvert) | Customer-facing FM CTA / clinical-adjacent | current | 2026-05-18 · non-cash PASS; clinical TRT claims **softened** (Keith "all three"); landing/JoinForm/status/ResultConvert pre-flighted **PASS 0 HARD** | Keith + **Ewa (clinical)** | 🟠 PARTIAL — non-cash Keith-approved; clinical softened; landing surfaces PASS; **only Ewa's clinical countersignature on softened seq-03b text remains** | `approval-record-fm-cta-language-2026-05-18.md` |
...
*Created 2026-05-18 · Updated 2026-05-18 (Ewa+Keith sign-off) · Owner: Keith Antony · Law: `03_compliance/CONTEXT.md`.*
