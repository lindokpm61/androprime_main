...
| Strategic role | **Acquisition front door** — captures high-volume liver search, upsells to hormone/metabolic line. NOT a TRT-pipeline driver (statins are POM). ⚠️ **The "no EFSA liver-supplement claim" half of this line is WRONG, corrected 2026-08-20.** **Choline carries an authorised claim for the maintenance of normal liver function**, at a condition of 82.5 mg per serving. Nutribl's Liver Support Choline Complex is formulated to exactly that threshold and is available at MOQ 10 (GBP 4.57). So a liver → choline supplement loop is **possible**, not impossible, and the strategic role above may be understated. **This is not a recommendation.** Our stated route for elevated liver markers is a GP referral, and selling a supplement off a raised ALT is uncomfortable ground; only the choline in that 12-ingredient blend carries a claim, so a clean choline product would be the shape. **Ewa gate before this is pursued.** See `../supplements/biomarker-supplement-loops.md`, Supplier availability section. | — |
