...
> ⛔ **LOW-T ROUTING SUPERSEDED 2026-06-04 (Ewa CA-013/014).** Every "T < 12 → founding-member list / FM CTA" reference in this guide (result mapping, seq-03b, metrics, schema) is the old model. Low-T now routes to a **GP referral** (no upsell) + an optional consent-gated nurture opt-in; the FM list was **taken down** (join route → 410). `founding_member_list` table + `founding_member_listed` event remain defined but dormant. seq-03b was rewritten to GP-focused (Part A) + education-only consent nurture (Part B, CIO campaign 5, DRAFT). Read FM references as GP-referral + nurture. The £75 FM deposit was shelved 2026-05-08 — never mention it as live. Authoritative: `04_products/CONTEXT.md` + `results-engine/2026-06-04-low-t-routing-decision.md`.

**Original date:** March 30, 2026
**Last updated:** April 20, 2026 (low-T routing superseded 2026-06-04 — see banner)
**Owner:** Keith Antony
