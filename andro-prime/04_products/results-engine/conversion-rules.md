...
|---|---|---|---|
| Low testosterone (T < 12 nmol/L, Kit 1 or Kit 3) | `founding_member_listed` | None | Unchanged. (v2 reinstates Daily Stack as a secondary `subscription_started` target.) |
...
- `founding_member_listed` — fires when a customer joins the founding-member list (non-cash opt-in). Used as both a conversion event and a seq-03b stop-goal.
