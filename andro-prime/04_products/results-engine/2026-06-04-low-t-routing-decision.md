...
- **Lawful basis (solicitor / task 06 `869d99kzh`):** needs **Article 6(1)(a) consent AND Article 9(2)(a) explicit consent**, captured at the "keep your results + stay in touch" point. Reframe the task from "FM list" to "store low-T results + nurture" — a cleaner thing to sign off. Storing the result to *deliver his test* is already covered; the *new* purpose (segment + nurture) is what needs the consent.
