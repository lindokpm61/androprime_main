...
**Manufacturers, Gate 0A dependency:** No supplement MOQ order until Gate 0A is met (25+ supplement pre-orders; the deposit mechanic was shelved 2026-05-08; see `04_products/CONTEXT.md`). Manufacturer outreach has **started** under the 2026-06-26 stock-first pivot (`manufacturers/outreach-tracker.md`; candidate dirs `vita-manufacture/`, `synergy-biologics/`, `nutribl/`, `natures-aid/`, `rawcreation/`), superseding the old "not started / Supplement Factory + Arena Health" framing. Rawcreation is the only manufacturer contacted so far (enquiry sent 2026-07-02); the Partner Status table above now reflects the live tracker. Formulation specs: `04_products/supplements/`.
