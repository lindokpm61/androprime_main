          ...
          <div className="grid lg:grid-cols-12 gap-16 lg:gap-20 items-start">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-32">
              <div className="border-4 border-black bg-black text-white p-10 md:p-12 relative overflow-hidden">
                ...
                <a href="#" className="block w-full text-center bg-white text-black hover:bg-gray-200 border-4 border-white font-sans font-black uppercase tracking-widest text-lg px-8 py-5 transition-colors mb-6">
                  Subscribe Now
                </a>
