        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-20 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            {[
              ...
              { title: 'Below clinical threshold', body: "You're invited to join the Founding Member programme. First access to clinical support when it launches, with a fully refundable £75 deposit.", icon: <path d="M13 10V3L4 14h7v7l9-11h-7z" />, dark: false },
