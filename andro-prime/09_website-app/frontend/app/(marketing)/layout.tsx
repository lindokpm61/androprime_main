...
export default function MarketingLayout({
  ...
  return (
    <>
      {/* The `.js` gate and the reveal observer. Moved into `RevealGate` on
          2026-09-11 so the `/lp` tree could use the same pair rather than a
          second copy of a 2.5s failsafe; the three fallbacks and why each one
          matters are documented in that component. */}
      <RevealGate />
