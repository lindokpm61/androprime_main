...
const faqItems = [
  ...
  { q: 'Can I take this alongside the Daily Stack?', a: 'Yes. They\'re designed to work together. The Daily Stack covers your energy and recovery basics (zinc, magnesium, D3, B12). The Collagen focuses on connective tissue and joint comfort support. No ingredient overlap.' },
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 data-label border-t-2 border-black pt-6 w-full">
              {['UKAS ISO 15189 Accredited Lab', 'EFSA-Approved Claims', 'GMC Doctor Reviewed', 'Free Delivery', 'Cancel Anytime'].map((item) => (
