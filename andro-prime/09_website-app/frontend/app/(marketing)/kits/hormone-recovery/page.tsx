...
export default function KitHormoneRecoveryPage() {
  ...
  return (
    <div className="f-page">
      ...
      <div className="f-wrap f-sec f-sec-cont">
        <SectionRule n={2} of={8} />
