      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: { '@type': 'Answer', text: 'Yes, for the markers we test. UKAS-accredited labs validate their finger-prick collection methods against venous samples. Our lab partner is ISO 15189 certified, the same standard as NHS laboratories. The key requirement is correct collection: fasted, first thing in the morning, with a warm hand to encourage blood flow.' },
        },
        {
          '@type': 'Question',
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            <div>
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                {['UKAS ISO 15189', 'Results in 2 to 5 working days'].map(label => (
