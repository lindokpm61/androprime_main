...
const homeSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      text: 'Access your secure dashboard within 2 to 5 working days of lab receipt. Clear data, a GP-designed report, and actionable recommendations in plain English.',
      url: `${BASE_URL}/kits`,
    },
  ],
}
