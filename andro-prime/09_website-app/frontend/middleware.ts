...
const protectedRoutes = [
  ...
  '/subscriptions',
  '/account',
  // NOTE: the member screen is /account/membership, which '/account' above
  // already covers via the startsWith arm of isProtectedPath. It is NOT listed
  // separately, and it must not be: the bare '/membership' is now the PUBLIC
  // marketing explainer and gating it would send every logged-out visitor to a
  // login page instead of the page that discloses the price (moved 2026-09-08).
