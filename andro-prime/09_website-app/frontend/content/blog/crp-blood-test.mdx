...
faq:
  - a: >-
      A CRP blood test measures C-reactive protein, a protein your liver
      releases when your immune system is responding to irritation, injury or
      infection. In the UK, NHS labs report under 5 mg/L as the standard normal
      cutoff. Private panels usually run the high-sensitivity version (hs-CRP),
      which picks up much lower readings. The test tells you whether there is a
      measurable signal, not what's causing it.
    q: What is a CRP blood test?
  - a: >-
      CRP stands for C-reactive protein. It's a chemical your liver produces in
      response to immune-system activity anywhere in the body. A CRP result on a
      blood test is a number in mg/L, a snapshot of how much of that protein was
      circulating when the sample was taken. It doesn't name a cause and it
      doesn't diagnose anything on its own.
    q: What does CRP mean in a blood test?
  - a: >-
      On a standard NHS CRP test, under 5 mg/L is reported as normal. On a
      high-sensitivity (hs-CRP) test (the version most UK private labs run) the
      bands are different. Under 1.0 mg/L is low. 1.0 to 3.0 mg/L is average.
      Over 3.0 mg/L is elevated. The hs-CRP framework is the more useful one for
      recovery-aware tracking in otherwise healthy men.
    q: What is a normal CRP level in the UK?
  - a: >-
      A raised CRP means there is more C-reactive protein in your blood than
      expected. The commonest causes in otherwise healthy active men are recent
      illness or injury, a hard training block without proper recovery, sleep
      debt, body composition, alcohol, and ultra-processed food intake. Less
      commonly, dental infection, gut issues or an undiagnosed inflammatory
      condition can drive it. A single high reading doesn't name the cause.
    q: What does raised or high CRP mean?
  - a: >-
      Any single CRP reading over 10 mg/L on a non-acute baseline is a same-week
      GP conversation; that range points to active infection or a significant
      inflammatory event. Persistently above 3 mg/L on hs-CRP across two retests
      8 weeks apart, with no obvious lifestyle cause, is also a GP referral. A
      reading alongside unexplained weight loss, night sweats or persistent
      fever is a GP appointment urgently, regardless of the number.
    q: How much CRP is dangerous?
  - a: >-
      Same protein, different test sensitivity. Standard CRP is built to flag
      obvious infection or inflammation; it reports down to roughly 5 mg/L.
      hs-CRP (high-sensitivity C-reactive protein) picks up readings well below
      that, which is what matters for low-grade background inflammation and
      long-term cardiovascular risk in otherwise healthy men. For tracking how
      you actually feel, hs-CRP is the one to ask for.
    q: What's the difference between CRP and hs-CRP?
  - a: >-
      It's rarely wrong, but it's often misleading on its own. A cold, a hard
      training session in the last 48 hours, recent dental work, a fresh
      vaccination, even a flare of hay fever can push CRP up temporarily. None
      of those things change your baseline. The honest reading is the one you
      take 4 to 8 weeks later, when you're not acutely ill and haven't trained
      brutally the day before.
    q: Can a single high CRP reading be wrong?
  - a: >-
      A long list, and that's the point. Common ones include upper respiratory
      infections, dental abscesses, urinary tract infections, sinusitis, and
      post-vaccination immune response. CRP rises with most acute bacterial
      infections and some viral ones. The test doesn't tell you which infection.
      If you're symptomatic with a high CRP, that's a GP conversation, not a
...
status: published
excerpt: >-
  What a CRP blood test measures, what counts as high in the UK, and what to do
  with the number. Reviewed by GMC-registered GP Dr Ewa Lindo.
...
keyword_coverage:
  brief: >-
    andro-prime/06_marketing/seo-ai-search/article-briefs/pillar-D-hub-crp-blood-test.md
...
## Who puts hs-CRP on a form, and why

Almost nobody arrives at hs-CRP on purpose. Somebody put it in front of you.
...
## Reading hs-CRP over time, not once

One hs-CRP reading is a moment. The picture is in the repeats.
...
We're built for the recovery-aware man tracking what his body is doing. We're not built for diagnosis or treatment. The line sits here.
