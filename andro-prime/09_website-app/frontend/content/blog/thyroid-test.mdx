...
If several of these have persisted for weeks, and the obvious explanations don't fit, a thyroid test is a reasonable next step. Not a panic. A reasonable next step.
