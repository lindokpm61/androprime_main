...
The symptoms you described are most commonly linked to testosterone. The most direct way to find out whether that's the cause is to test it. Kit 1 checks total testosterone, SHBG, Free Androgen Index, and Albumin. Results in 2 to 5 working days of the lab receiving your sample.
...
What you described points to the energy and recovery panel. Vitamin D, B12, hs-CRP, and Ferritin are the four markers that most directly explain why active men stop recovering like they used to. Kit 2 checks all four. Results in 2 to 5 working days of the lab receiving your sample.
...
The ambiguity in what you described is what pointed us to Kit 3. It covers 9 markers across testosterone, energy, and inflammation, so wherever the cause is, you'll find it in one test. Results in 2 to 5 working days of the lab receiving your sample.
...
{% if customer.quiz_recommended_kit == 'testosterone' %}
Kit 1 is £99. Five minutes of your time when the kit arrives. The finger-prick sample goes in a pre-paid Royal Mail envelope. Results within 2 to 5 working days of the lab receiving it.

**Order here:** https://andro-prime.com/kits/testosterone

{% elsif customer.quiz_recommended_kit == 'energy-recovery' %}
Kit 2 is £119. Same process: finger-prick, pre-paid envelope, results typically within 2 to 5 working days.

**Order here:** https://andro-prime.com/kits/energy-recovery

{% elsif customer.quiz_recommended_kit == 'hormone-recovery' %}
Kit 3 is £179 for 9 markers. Same process: finger-prick, pre-paid envelope, results typically within 2 to 5 working days.
...
The alternative is the GP appointment. Which often ends with "your levels are normal," with no context, no trend, no explanation of what normal means for you specifically. And you're back where you started, but a few weeks later.
...
**Order Kit 1: £99:** https://andro-prime.com/kits/testosterone
...
**Order Kit 2: £119:** https://andro-prime.com/kits/energy-recovery
...
**Order Kit 3: £179:** https://andro-prime.com/kits/hormone-recovery
{% endif %}
...
Finger-prick sample at home. Pre-paid Royal Mail envelope. Results typically within 2 to 5 working days. Results in plain English with Dr Ewa Lindo's review: Vitamin D, B12, hs-CRP, Ferritin.
...
Nine markers: total testosterone, SHBG, Free Androgen Index, Albumin, Free T, Vitamin D, B12, hs-CRP, Ferritin. Finger-prick sample, pre-paid envelope, results typically within 2 to 5 working days. Plain English results with Dr Ewa Lindo's review. One-off payment. No subscription.
