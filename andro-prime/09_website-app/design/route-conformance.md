...
**28 of 36 measurable routes are Direction F (78%).** Measured 2026-09-10.
...
be waiting: 8 routes are still on the old design.
...
_Generated by `frontend/scripts/route-conformance.js` on 2026-09-10. 43 routes
