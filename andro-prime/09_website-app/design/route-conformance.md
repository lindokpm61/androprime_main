...
**33 of 36 measurable routes are Direction F (92%).** Measured 2026-09-11.
...
## F classes defined and rendered nowhere (194)
...
### Asked for by a source file, so not dead (168)
...
be waiting: 3 routes are still on the old design.
...
_Generated by `frontend/scripts/route-conformance.js` on 2026-09-11. 43 routes
