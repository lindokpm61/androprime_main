...
THIS IS WHERE THE CONVERSATION STOPPED AND KEITH HAS NOT CHOSEN YET.**
...
**Assistant recommendation, not decided: B before A.** A tells you the mockups
disagree with each other, which is real but not blocking; B stops the next page
shipping a defect and is the half currently being rebuilt by hand every time.
**Owner: Keith.**
...
## ▶️ NEWEST — dark-panel contrast, fixed as a mechanism rather than a list, 2026-09-08
