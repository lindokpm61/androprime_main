...
**THREAD 1 — the route-coverage gap. 11 rebuilt, 32 not.**

Measured 2026-09-08 by rendering every route and counting body-level `f-`/`fb-`
classes with the 21-class Nav/Footer chrome subtracted. **Not yet rebuilt:**
...
`/ops/content`, `/go` (internal, no public UI).
...
🟢 KEITH CHOSE **B**, THEN **C**, ON 2026-09-08, AND BOTH ARE DONE. **A IS RETIRED, NOT DEFERRED. ONLY D IS OPEN.**
...
**D is the only Thread 2 item left open** (a committed route-conformance report,
so the Thread 1 count cannot go stale the way "six routes" did). It also absorbs
the one thing the reconciler reported that had real content: its unpaired
selectors are components the app has not ported, and a conformance report
measures that against rendered routes rather than against drawings.
**Owner: Keith.**
...
## ▶️ NEWEST — the page scaffold, and the three shapes the hero had quietly become, 2026-09-08
