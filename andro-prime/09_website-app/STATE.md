...
### ~~Left in the working tree, NOT committed~~ — COMMITTED 2026-09-08 late

Those three files are now in, under a message that names both changes. The
`/demo` preview work is below; the six colour-literal fixes riding in
`app-shell.css` were a THIRD session's and are described in the commit rather
