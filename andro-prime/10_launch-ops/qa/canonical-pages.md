...
| P2 | Kit 3 "Seven markers" vs "nine markers" elsewhere | `how-it-works/page.tsx:334` | Change to "Nine markers" |
| P2 | Contact page is mailto-only, no wired form | `contact/page.tsx:57,66,177` | Confirm intended or add wired form |
| P2 | Blog newsletter `<form>` has no handler | `blog/page.tsx:124-127` | Wire to newsletter endpoint or remove |
| P2 | Em dash in visible copy (CTA buttons) | `kits/testosterone/page.tsx:63,329`; `kits/energy-recovery/page.tsx:125,278,289`; `kits/hormone-recovery/page.tsx:124,713,62` | Replace `—`/`&mdash;` with colon/full stop |
| P2 | Em dash in visible copy | `founding-member/page.tsx:18,55,106`; `components/founding-member/JoinForm.tsx:56`; `components/marketing/TestSelectorQuiz.tsx:249`; `components/marketing/WaitlistForm.tsx:47` | Replace |
