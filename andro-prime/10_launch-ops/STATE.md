...
- `869e0bc7k` **Update the privacy policy and sync the live page** — in progress.
...
- `869e0bceu` **Record the real Supabase position; fix wrong "EU (Frankfurt)" references; sign the DPIA** — in progress. **The DPIA is unsigned.**
- `869e0bcf4` **Decide the pre-consent health-trait emission to Customer.io** — in progress.
