...
> ⛔ **GATE DEFINITIONS RETIRED (gate ruling restated by Keith 2026-07-09) — canonical set now in `01_strategy/CONTEXT.md` (Gates Reference).** The 0A/0B/0C rows in the table below, the Gate 0A/0B mentions in the §6.2 Week-6 / Week-10 schedule above, and every other numeric 0A/0B mention in this blueprint (the §8.1 KPI-dashboard rows and the §9 risk-register rows further below) are one of four old conflicting numeric sets — **all of them defined 0A/0B on supplement metrics** (pre-orders, kit→supplement conversion, supplement MRR). The **2026-05-23 supplements-deferred decision** replaced buy-now supplement CTAs with a non-cash waitlist, so those metrics do not exist in Phase 0a; the 0A/0B numbers here are **RETIRED**. Under the restatement: operational launch gate **0A** = capped-downside spend authorisation (defined in `10_launch-ops/implementation-checklists/qa-gates.md`); **0B** = unit-economics gate (CPA < kit gross contribution £38/£53/£77; post-supplement CPA < blended LTV ~£165); **0C** = Month-12 cumulative cash vs the £30k threshold (unchanged — note this blueprint's "Gate 0C = Month 4, 150+ kits" row below is itself a retired definition; the canonical 0C is the Month-12 cash gate). 0B/0C are STRATEGIC post-launch gates, not launch blockers; all restated criteria live in `01_strategy/CONTEXT.md`. (An earlier note this morning cited `andro-prime-strategic-model-v7.md`'s numbers as canonical-by-adoption; that is withdrawn — v7's 0A/0B are equally retired, and only its 0C survived.) Body preserved for history; do not use these numbers for live gate criteria.
...
|---|---|---|---|---|
| **Gate 0A** ⛔ RETIRED 2026-07-09 | Week 6 | 50+ total kits sold AND 25+ FM markers (non-cash opt-in; deposit shelved 2026-05-08) | Place supplement manufacturing order. Launch Kit 2. | Extend Kit 1 marketing. Delay supplement order. Investigate conversion. |
| **Gate 0B** ⛔ RETIRED 2026-07-09 | Week 10 | 10%+ of Kit 2/3 buyers converting to at least one supplement subscription | Scale paid ads. Expand Kit 2/3 content. Launch Kit 3. | Revise results report copy. Test alternative recommendation approaches. Review pricing. |
| **Gate 0C** ⛔ RETIRED 2026-07-09 (this Month-4 volume definition is **not** canonical 0C) | Month 4 | 150+ total kits sold. 30+ active supplement subscribers. Supplement MRR above £1,000/month. | Full confidence in non-regulated tier. Begin CQC clinical prep in earnest. | Reassess product-market fit. Review kit pricing or supplement formulations. |
