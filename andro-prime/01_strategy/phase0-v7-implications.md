...
**What does NOT change:** V7 adds a gate (Tracker-Engage) rather than dropping the gate concept. **[Corrected 2026-07-09 per the gate ruling (audit 2026-07-05, criteria restated by Keith 2026-07-09):** the earlier claim that "Gates 0A, 0B, 0C, 1, 2, 3 all stand" is withdrawn — the gate *set* was not left intact. The gates were **both reclassified and had their 0A/0B criteria retired**: the canonical operational launch gates are qa-gates 1–5 + Gate 0A (the only launch blockers); Gates 0B/0C are strategic post-launch gates, not launch blockers. **The old 0A/0B numeric criteria (kit-count / FM-opt-in / supplement-MRR thresholds) are RETIRED** — the 2026-05-23 supplements-deferred decision removed the buy-now supplement metrics they depended on — and the restated criteria (0A = capped-downside spend authorisation; 0B = unit-economics; 0C = Month-12 cash, unchanged) now live in `01_strategy/CONTEXT.md` (Gates Reference). Do not cite "all gates stand," and do not treat this doc's Week-6/M4 gate instrumentation notes above (§decision-discipline) as live criteria.]
