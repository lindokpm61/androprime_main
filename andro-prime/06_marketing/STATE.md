...
- **🔴 THE B12 BAND ON THE SLIDE WAS WRONG, AND SO IS THE LIVE ARTICLE. Both corrected.** The deck said "under 35 is low", inherited verbatim from `content/blog/b12-blood-test.mdx`, which attributes it to *"the bands Andro Prime's Kit 2 reads against"*. `classifier.ts:325` reads `value < 25` on the NICE NG239 three-band scheme **Ewa signed 2026-06-16 and re-ratified 2026-08-07**. The article published 2026-06-20, four days after that decision, and was never swept. Deck and article both now read `<25 / 25–70 / >70` and cite NG239. **No fresh sign-off sought**: this applies her decided value, on the precedent of the 2026-07-25 `6 → 12` GP-threshold fix. The article fix is a live-copy change and still needs deploying.
