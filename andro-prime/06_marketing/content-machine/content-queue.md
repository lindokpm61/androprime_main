...
| X-03 | week 3 | `why-am-i-always-tired` `[W]` | B | The broadest pain point in the avatar. **APPROVED by Keith 2026-08-17 and REGISTERED**, batch `drafts/x-week-2026-08-24.md`, 7 posts for 24 to 30 Aug, pre-flight clean on the payload (0 HARD both scanners, 0 REVIEW on G5). Six renditions carry `publisher='metricool'` with their slots; the Sunday thread carries `publisher='manual'`. **SCHEDULED 2026-08-17**: six drafts Mon to Sat (`362835628`, `362835629`, `362835631`, `362835632`, `362835633`, `362835635`), all verified against Metricool own calendar and all needing arming. The Sunday thread was refused by name as `publisher=manual`, which is the by-hand rule enforcing itself.** This pillar already carries FIVE derivatives, the most on the board, so the accumulation framing, the marker list and sleep quality were all spent before this week started. Angle is the ground none of them took: the wired-but-tired loop, training load versus recovery from both ends, the NHS input numbers, and the fortnight test. ✅ **The CA-029 surface gap that weeks 1 and 2 both carried is CLOSED** (Keith, 2026-08-16): X is a named surface, and the omission was only ever because X had not been configured when the approval was written. Wednesday's post still does not use the established headline, now as an editorial choice about repetition rather than a compliance workaround. |
