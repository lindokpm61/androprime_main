---
slug: the-number-not-on-the-panel
title: The number that isn't on the panel (ApoB, and what a cholesterol test skips)
content_type: educational
funnel_stage: MOFU
funnel_job: marker explainer (cholesterol / ApoB), route to the canonical hub
awareness: problem-aware
cta: canonical-article
channel: linkedin
marker: none
canonical_asset: cholesterol-test
series: none
renditions:
  - platform: linkedin
    format: text-post
...
| --- | --- | --- | --- | --- | --- |
| linkedin/text-post | scheduled | 2026-08-17 10:00 UTC |  | metricool 362811189 |  |
<!-- END GENERATED STATE -->

## Chosen hook

Archetype: Contrarian, aimed at the covering note rather than at the GP who wrote it.

Line 1 opens on the verdict a man was actually handed, in his own report's words, and the second line takes it apart. The wedge is not normal-versus-optimal, which this account has now used on testosterone, ferritin and B12. It is **count versus weight**: the standard panel measures how much cholesterol is being carried, and the thing that lodges in an artery wall is how many particles are carrying it.

## Script

POST

> "Slightly raised. Nothing to worry about."
>
> That was the covering note. A verdict, and not one of the five numbers behind it.
>
> Because a cholesterol test isn't one number. It's five. Total, LDL, HDL, triglycerides, and non-HDL, which is total minus your HDL and the figure the NHS now leads with.
>
> Total on its own is the least useful line on the page. It adds the harmful and the protective together and hands you the sum. Two men can share an identical total and carry completely different risk, depending on how it splits.
>
> So far, so fixable. Read the panel instead of the headline.
>
...
>
> He didn't have a cholesterol problem. He had a measurement problem.
>
> ApoB isn't routine on the NHS, and that's cost and policy rather than a verdict on the marker. Total, HDL and non-HDL are cheap enough to screen a whole population with, so that's what gets run.
>
...
**Emotion: recognition, then vindication.** Recognition at the covering note, which is the artefact Mark actually holds. Vindication at the reveal that the reassurance was measuring the wrong quantity, which is the same wound as the reference range without reusing its wording.

**Why this wedge and not the usual one.** The normal-versus-optimal wedge is this account's signature and it has now carried testosterone, ferritin and B12. Reaching for it a fourth time would make the wedge the voice. Count versus weight is a genuinely different mechanism, it is the article's own strongest section, and it earns the "one most men miss" in the article's title.

**Shape check against the library, run before drafting** (`/script` Step 4b). Openers in the 17 live assets converge on `Most men…` (three) and `If you are…` (two), and `A man I know` is now taken by `the-stack`. **Six of the nine non-statement closes open with an `If you…` conditional.** This post opens on a quotation, which nothing in the library does, and closes on a second-person question hung off the last concrete detail with no conditional. The closing question itself is kept: it is mandated, and it is not what was converging.

**Founder reveal is used, and it is doing unusual work.** On most posts it is a warm close. Here it carries the honest limit: the reveal and the "we don't test this yet" are the same sentence, so the disclosure lands as candour rather than as a pitch.

## Claim inheritance check

Every figure and mechanism is in `cholesterol-test`, published 2026-07-15, Ewa-reviewed. Nothing net-new.

| The post says | Article source |
| --- | --- |
| "Slightly raised. Nothing to worry about." as the covering note | the opening scene |
| Five numbers: total, LDL, HDL, triglycerides, non-HDL | "What a cholesterol test actually measures" |
...
| ApoB not routine on the NHS: cost and policy, not lack of value | "Why the NHS doesn't routinely test it" |
| FH about 1 in 250 in the UK, most unaware, British Heart Foundation | "What raised numbers usually mean in active men" |
| No cholesterol panel to sell today | "How Andro Prime will measure this" |
...
- ✅ **SETTLED 2026-08-18, and the live post predates it.** Ewa ruled that `cholesterol-test` gains a 999 line for sudden or severe chest pain and keeps its GP line for everything else; `one-load-five-places` is unchanged. The article was corrected the same day and the post body above now carries the escalation. 🔴 **The LinkedIn rendition published on 2026-08-17 does NOT**: it is live, and it routes all chest pain, sudden or severe included, to the GP. The copy above and the post on the feed therefore disagree until someone acts. **Keith's call, and it is outward-facing either way:** edit the live post in place on LinkedIn to carry the 999 line, or leave it and accept that one live derivative is behind the ruling. Not done here. The original open item, kept for the trail:
- ⚠️ **Was open, inherited, and NOT a gate on this post: chest pain routes to the GP here and to 999 in `one-load-five-places`.** Both are faithful to their own signed article, so neither post introduced it, but two Ewa-signed sources give overlapping symptoms different escalations and both are about to be live on the same feed. **Which escalation chest pain gets is a clinical question**, and it belongs at Ewa's next pass rather than blocking this one.
