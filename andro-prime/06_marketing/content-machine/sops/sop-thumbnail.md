...
5. **Export** at the size for each surface needed.
6. **Keith approves** before it ships (same imagery bar as the Unsplash hold: Keith eyeballs founder-facing imagery first).
