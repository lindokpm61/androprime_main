...
2. **Founding-member £75 deposit mechanic shelved** as a Phase 0 economic lever (per Keith 2026-05-08 + `01_strategy/trt-launch-readiness-2026-05-08.md`). Phase 0 economics no longer rely on deposit float. **Founding-member is KEPT as a non-cash opt-in marker (Keith 2026-05-08)** — it lives in the warm-pipeline-across-signals metric (active Daily Stack subscribers + opted-in marker-list + engaged low-T results). The marker-list mechanic continues; final wording is Ewa-led. The marker is not included in v2.3 financial calcs (no cash float).
...
## 2. The Strategic Bet (and what would prove it wrong)

### The bet

PTs are the highest-leverage single channel for Andro Prime at premium pricing because:

1. They have permission to discuss energy, recovery, and performance with their clients — and a £119 home test fits naturally into a "let's actually find out what's going on" conversation that an Instagram ad cannot replicate.
2. The recommendation is a warm referral by definition.
3. Repeated exposure across multiple training sessions compounds conversion.
4. The product makes their service better — a PT who knows their client's vitamin D, B12, ferritin, and CRP writes smarter training plans.
5. Premium price points actually *favour* PT recommendation over cold ads, because trust friction matters more at £119 than at £29.
6. UK PTs are not currently a target of any direct competitor's affiliate programme.
...
### Where the premium price specifically makes things harder

A £107 kit (after 10% PT discount) is still not an impulse buy. Customer journey from PT recommendation to purchase is 3–7 days, sometimes longer. The plan accommodates by:

- Lower productivity assumptions (1.0–1.2 kits/active PT/month)
- Longer "first sale" window (45 days post-onboarding)
- Stronger email nurture sequence (4 emails over 5 days)
...
|---|---|---|
| Pre-issuance brief | Every PT signs a written attestation before code issuance covering: no medical claims, no TRT availability claims, no Ashwagandha mentions, no diagnostic language, no implied product cure of any condition, **and exact discount language (10% only — never imply more)** | Keith |
| Asset pack | Pre-approved Story scripts, Reel scripts, post captions, client conversation Q&A — built around credibility-led personal-story framing for free-kit PTs and value-led 10% discount framing for the rest | Keith + Ewa |
| Weekly content audit | Automated scrape of Instagram and LinkedIn for handle mentions + manual review of top 20 PTs each week | Keith (later: VA) |
| 3-strikes enforcement | 1st: written warning + correction. 2nd: code paused 30 days. 3rd: code revoked. | Keith |
| Kill switch | Any ASA query or regulator DM: code revoked same day, post takedown requested, incident logged | Keith |

**Absolute rules (zero tolerance, immediate revocation):**
- Ashwagandha mentioned by name
- "TRT is available now" or any equivalent
- A false medical diagnosis claim
- A false cure claim

**Hybrid-model-specific compliance rule:** PTs may say "use my code, get 10% off" — they may NOT say "20% off," "biggest discount available," "exclusive deal," or other inflated framing. The ASA polices "exaggerated savings claims" specifically. First violation = strike-1.
...
> Andro Prime is the men's health company that finds out what's actually wrong before telling you what to do about it. Built by a man who went through it. Guided by a GP who treats it. Sold without jargon — and without apology for what it costs.

### Voice Test
Would Keith say this to a friend in a pub? If not, rewrite it. (Full voice rules: `06_marketing/positioning/product-marketing-context.md`)

### Premium price + 10% discount — how to talk about it
...
### What "premium with discount" rules out

- Discount-led promotion. The 10% is a token of credibility ("your PT vouched for you"), not a sales tactic.
- Hard-sell language. "Limited time only" — banned.
- Stock photo people. Real Keith. Real Ewa. Real customers (when consented).
...
│ Channels: PT social content, micro-influencer kit reveals,         │
│           Keith's LinkedIn, Reddit (low effort), YouTube           │
└──────────────────────────┬─────────────────────────────────────────┘
                           ▼
┌────────────────────────────────────────────────────────────────────┐
│ CONSIDERATION (MOFU)                                               │
│ "£107–£161 is real money — is this credible?"                      │
│ Channels: Site, Ewa's bio, results dashboard demo, testimonials,   │
│           email opt-in (4-email nurture)                           │
└──────────────────────────┬─────────────────────────────────────────┘
                           ▼
┌────────────────────────────────────────────────────────────────────┐
│ DECISION (BOFU)                                                    │
│ "Buying — and I get 10% off via my PT's code"                      │
│ Channels: PT-coded checkout (10% discount), influencer-coded       │
│           checkout, direct site, branded organic search            │
└──────────────────────────┬─────────────────────────────────────────┘
                           ▼
┌────────────────────────────────────────────────────────────────────┐
...
|---|---|---|---|---|
| Attention | PT-driven content impressions/month | 20k | 150k | 400k |
| Attention | Influencer impressions/month | 8k | 60k | 200k |
| Consideration | Site visitors/month | 1,200 | 6,000 | 18,000 |
| Consideration | Email list size | 200 | 900 | 2,800 |
...
| Sub-channel | % of recruits | Speed | Quality |
|---|---|---|---|
...
|---|---|---|
| Flagship PTs (3–5) | **Yes — Kit 3 (£98 COGS each, ~£294–£490 total)** | Optional — flagship PT chooses if they want their audience to get the discount |
...
| Per-kit | Kit 1 (£99 → £89.10) | Kit 2 (£119 → £107.10) | Kit 3 (£179 → £161.10) |
|---|---|---|---|
...
### 6.3 Keith's LinkedIn

3 posts/week minimum, 5 stretch. Content pillars: founder story, education, PT spotlight (M2+), customer language, Ewa's voice, industry/market.

100+ comments per week on adjacent posts (UK men's fitness, founder content, GP/clinical voices). 30 min/day.

### 6.4 Earned Media + SEO

Earned-media pitchable story:
...
Trust-building only. Keith and Ewa post in r/AskUK, r/UKmen, r/Testosterone, r/menshealth. Helpful answers, no link spam. 20 min/day.
...
**Product:** Kit 3 (Hormone & Recovery Check) — £179 RRP / £161.10 with PT code
**Audience:** Existing Kit 2 buyers + new ICP 3 acquisition
**Pricing benchmark in copy:** Position against MediChecks Well Man Test (£89–149).
...
## 9. Volume Mathematics — How 100 Kits/Month Actually Happens

| Source | PTs/influencers needed | Activity needed | Kit volume |
|---|---|---|---|
| Active PTs | 60 | 1.0 sales/PT/month | 60 |
| Active influencers | 15 | 1.5 sales/influencer/month | 22 |
| Keith's LinkedIn + organic site | n/a | Branded search + earned media | 18 |
| **Total** | | | **100** |

**Distribution at 100 active PTs (M6 target):**

| Tier | Headcount | Avg/PT/mo | Total |
|---|---|---|---|
| Gold | 8 | 8 | 64 |
| Silver | 17 | 3 | 51 |
| Bronze (active) | 75 | 0.5 | 38 |
| Bronze (dormant) | 50 | 0 | 0 |
| **Total** | **150 enrolled, 100 active** | | **153** |

PT-only ≈ 150. Add influencer + organic ≈ **~200 kits/month at 100 active PTs.** Comfortably above 100/month minimum.
...
| New influencers onboarded | 2–3 | 1–2 | < 1 for 2 weeks |
...
7. **Per-kit blended affiliate net (Kit 1) drops below £10 sustained for 30 days (v2.3 — LOCKED Keith 2026-05-08).** v2.2's tripwire was "blended below £15." Under v2.3 the Kit 1 affiliate net is £13.37 base, falling to £3.37 at full bonus stack. The £15 floor is therefore not a useful threshold for Kit 1 under v2.3 economics; the meaningful signal is the Kit 1 affiliate net falling below £10 sustained — which would indicate either bonus-stack over-payment (correctable by tightening triggers) or unexpected COGS drift. Threshold for Kit 2/Kit 3 remains effectively in place via the per-kit blended margin floor in Section 14. **The Kit 1-specific £10 sustained floor is the canonical Phase 0 tripwire under v2.3.**
...
|---|---|---|
| Vitall fulfilment | Untested above ~100/month | Confirm capacity Week -8 |
| Results dashboard | Built for 50/month | Load test at 150/month before M3 |
| Customer support | Keith handling at <30/month | VA hire at 60 kits/month sustained |
...
| Week | Action |
|---|---|
| -8 | Begin PT cold DM outreach (200/week). Begin influencer identification. Waitlist landing page live. Keith publishes first 2 LinkedIn pre-launch posts. **Vitall fulfilment capacity confirmation in writing.** |
| -7 | Continue PT DMs. Send free kits to 20 confirmed influencers + 3–5 flagship PTs. Reach out to 30 independent UK gyms. |
| -6 | Continue PT DMs. PT briefing pack v1 finalised with Ewa sign-off. FirstPromoter set up. **First-wave free kits dispatched to 15–20 high-credibility early-onboarded PTs.** |
| -5 | First flagship PT call. Onboard first 10 PTs (free-kit recipients). Keith publishes posts 3–4. |
| -4 | PT count: 25 onboarded. Influencer count: 8 confirmed. Compliance moderation system tested. |
| -3 | PT count: 35. Email list at 100+. **Beyond this point, new PTs get NO free kit but DO get the 10% customer discount.** |
| -2 | PT count: 45. Soft sandbox launch for top-5 PTs only. |
| -1 | PT count: 50. Final compliance audit. Launch email queued. |
| **0** | **LAUNCH. All codes live. Public site live. Influencer posts cleared. Keith publishes launch post. PT-only newsletter goes out.** |
...
|---|---|---|---|
| PT recruitment lags target | Medium | High | Multi-channel funnel + influencer fallback |
...
4. **Tripwire reconciliation (Kit 1 affiliate net floor) — RESOLVED Keith 2026-05-08.** Locked at £10 Kit 1 affiliate net sustained for 30 days (Section 10.7 §7). Kit-specific threshold (not blended-across-kits, not per-SKU). Phase 0 tripwire framework is now closed.
5. **Founding-member as non-cash opt-in marker — RESOLVED Keith 2026-05-08.** The marker-list mechanic IS KEPT under Option 4. It contributes to the warm-pipeline-across-signals metric (alongside active Daily Stack subscribers and engaged low-T results) and does NOT carry cash float. Final marker-list wording is Ewa-led but the concept is locked. Per `kit-strategy-decision-brief-2026-05-08.md` §8.5 + `trt-launch-readiness-2026-05-08.md`.
