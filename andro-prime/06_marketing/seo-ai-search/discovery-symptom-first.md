...
| **Male menopause / andropause** | ~10k cluster (menopause in male 5,400; "symptoms of male menopause" 1,600; "can/does male have menopause" 1,900 ea) | **12–28 (low!)** | Kit 1 / **Pillar E** | **Cleared and now served** (CA-028 2026-07-26, hub live 2026-07-30). The natural narrative wrapper for the whole low-T story. Per-asset Ewa sight still required. |
...
2. **The male-menopause/andropause umbrella (~10k, low KD) is the highest-leverage symptom narrative** — it wraps low-T, tiredness, libido, night sweats, belly fat into one story in the customer's words. It's **Pillar E, and it is now cleared** (CA-028, Ewa, 2026-07-26; hub live 2026-07-30). The demand and low KD said it was worth clearing, and it was.
...
- **Compliance flags:** sex drive, mood, and male-menopause framing are ASA/medical-claim-sensitive. Male-menopause framing is **no longer gated** (CA-028 approved 2026-07-26, hub live 2026-07-30) but every Pillar E asset still needs its own pre-flight plus Ewa's own sight. Sex drive and mood stay held. Internal demand mapping is fine either way; customer copy needs Ewa.
...
- **Pillar E (andropause) is data-justified and now cleared.** The Ewa compliance gate was cleared as CA-028 on 2026-07-26 and the hub published 2026-07-30. It is the umbrella narrative, low-KD, ~10k+. Next action is briefing the spokes, not chasing the sign-off.
