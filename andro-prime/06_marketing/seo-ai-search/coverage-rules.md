...
| Pillar E (andropause) ↔ Pillar C (testosterone) | Low T symptoms, hypogonadism | C answers "what's my testosterone number?" — universal male marker question. E answers "is this andropause?" — clinical-syndrome question. E's claims are fewer overall, because they are bounded by the CA-028 approved wording rather than by an open gate (pack approved 2026-07-26, hub live 2026-07-30; per-asset Ewa sight still required). |
